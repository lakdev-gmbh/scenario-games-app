...
export const NumericTask = React.forwardRef<ScenarioTaskRef, NumericProps>(
  ({solution, solve, setEmpty}, ref) => {
    ...
    return (
      <TextInput
        ...
        // TODO: Add this back in when we have a solution to closing the keyboard without return button
