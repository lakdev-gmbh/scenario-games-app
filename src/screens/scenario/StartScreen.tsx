...
export const ScenarioStartScreen = ({
  navigation,
  route,
}: NativeStackScreenProps<RootStackParamList, 'ScenarioStart'>) => {
    ...
    <View style={{flex: 1}}>
      <ImageBackground
        ...
        <LinearGradient
          ...
          colors={[
            themeColors.BACKGROUND_OVERLAY_START,
            themeColors.BACKGROUND_OVERLAY_END,
          ]}
          locations={[0.2, 1]}>
          <Image style={styles.owlImage} source={randomOwlImage} />
        </LinearGradient>
      </ImageBackground>
      ...
      <View style={[styles.container, globalStyles.container]}>
        ...
        <ScrollView>
          <DefaultText style={{flex: 1}}>{scenarioText}</DefaultText>
        </ScrollView>
